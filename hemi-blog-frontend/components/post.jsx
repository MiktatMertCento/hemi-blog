...
export default function PostComponent({ postInfo }) {
    ...
    return (
        <Box pos="relative" h="100%" w="100%" onClick={() => router.push(`/posts/${postInfo._id}`)} transition="all .2s" _hover={{ boxShadow: "0px 15px 25px -9px rgba(0,0,0,0.65)" }} _active={{ transform: "translateY(4px)" }}>

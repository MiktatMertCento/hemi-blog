...
export default function PostComponent({ postInfo }) {
    ...
    return (
        <Box pos="relative" h="100%" w="100%" onClick={() => router.push("/posts/123")} transition="all .4s" _hover={{ boxShadow: "0px 15px 45px -9px rgba(0,0,0,0.65)" }} _active={{ transform: "translateY(4px)" }}>
